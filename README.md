# YoloV3 aluminum defect custom training 
En este proyecto se presenta el entrenamiento de un dataset de defectos en superficies de aluminio para YOLOv3
...
### Preparar Dataset
  ...
  Para el archivo .cfg abrir el archivo bash .sh y modificar el parámetro NUM_CLASSES=6
